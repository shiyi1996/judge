...
CREATE TABLE `problem` (
  ...
  `input_case` varchar(200) NOT NULL COMMENT '样例输入',
  `output_case` varchar(200) NOT NULL COMMENT '样例输出',
...
CREATE TABLE `submit` (
  ...
  `result` varchar(20) DEFAULT NULL COMMENT '运行结果',
  `result_des` varchar(300) DEFAULT NULL COMMENT '结果描述',
  `case_result` varchar(400) DEFAULT NULL COMMENT '测试数据结果',
